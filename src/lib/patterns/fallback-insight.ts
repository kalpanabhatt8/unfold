/**
 * Fallback observations when the insight API is unavailable — second-person
 * rewrites of the pattern definitions. Better than "X keeps surfacing" but
 * still generic; the LLM path is preferred.
 */
...
export const fallbackPatternInsight = (name: PatternName): PatternInsight => ({
