  ...
  return createPortal(
    <div className="fixed inset-0 z-10000 flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative z-10 w-full max-w-lg max-h-[calc(100svh-2rem)] overflow-hidden rounded-xl border border-(--border) bg-(--surface-canvas) shadow-[0_1.25rem_3rem_-1rem_rgba(15,15,15,0.28)]"
